    ...
    <div class="border-b border-slate-700 bg-slate-800 text-white">
        ...
        >
            <div class="flex flex-wrap items-center gap-4 text-xs">
                ...
                >
                    <Phone class="h-3 w-3" /> {{ settings.phone_1 }}
                </Link>
                <Link
        ...
        <div class="mx-auto max-w-7xl px-4">
            <div class="flex items-center justify-between py-4">
                ...
                <nav class="hidden items-center gap-1 lg:flex">
                    ...
                    <Link
                        href="/contact-us"
                        class="ml-2 rounded bg-school-600 px-4 py-2 font-semibold text-white transition hover:bg-school-700"
                        >Contact Us</Link
                    >
                </nav>
                ...
                <div class="fixed inset-y-0 right-0 w-80 bg-white shadow-xl">
                    ...
                    <nav class="mt-8 flex flex-col space-y-4 px-6">
                        <Link
                            ...
                            :key="link.href"
                            :href="link.href"
                            class="border-b border-slate-200 text-lg font-medium text-slate-800"
                            @click="closeMobileMenu"
                        >
                            {{ link.label }}
                        </Link>
                        ...
                        <Link
                            href="/admission"
                            class="mt-4 rounded-lg bg-school-600 px-4 py-3 text-center text-lg font-semibold text-white"
                            @click="closeMobileMenu"
                            >Apply Now</Link
                        >
                    </nav>
